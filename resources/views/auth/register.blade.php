<div class="register-box">
    ...
    <!-- نمایش فرم یا پیام موفقیت -->
    @if ($registered)
        <div class="alert alert-success text-center mb-3">
            {{ session('status') }}
            <div class="mt-3">
                <a href="{{ route('verification.notice') }}" class="btn btn-primary">{{ __('Go to Email Verification') }}</a>
            </div>
        </div>
    @else
        <form wire:submit="register">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="text" name="middle_name" wire:model="middle_name"
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="text" name="display_name" wire:model="display_name"
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        <select name="gender" wire:model="gender"
                            class="form-control @error('gender') is-invalid @enderror" id="gender" required>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="date" name="birth_date" wire:model="birth_date"
                            ...
                            placeholder="Birth date" required max="{{ now()->subYears(18)->toDateString() }}">
                ...
                <div class="col-md-6">
                    ...
                    <small class="form-text text-muted fs-8">Required, valid email, max 255 characters, must be
                        unique.</small>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="input-group">
                        <input type="tel" name="phone_number" wire:model="phone_number"
                    ...
                    <small class="form-text text-muted fs-8">Required, format: +[country code][number], max 20 characters,
                        must be unique.</small>
                </div>
                <div class="col-md-6">
                    <div class="input-group">
                        <select name="born_country" wire:model="born_country"
                            class="form-control @error('born_country') is-invalid @enderror" id="born_country">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <div class="input-group">
                        <select name="living_country" wire:model="living_country"
                            class="form-control @error('living_country') is-invalid @enderror" id="living_country">
                            <option value="" selected>{{ __('Select a country (optional)') }}</option>
                            @foreach ($this->countries as $id => $name)
                                <option value="{{ $id }}">{{ $name }}</option>
                            @endforeach
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="text" name="father_name" wire:model="father_name"
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="text" name="mother_name" wire:model="mother_name"
                ...
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <div class="input-group-text">
                            <i class="{{ $showPassword ? 'bi bi-eye-slash' : 'bi bi-eye' }}" wire:click="togglePassword"
                    ...
                    <small class="form-text text-muted fs-8">Required, must match confirmation, follow password
                        rules.</small>
                </div>
                <div class="col-md-6">
                    <div class="input-group">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="form-check">
                        <input type="checkbox" name="agreement" wire:model="agreement"
                            class="form-check-input @error('agreement') is-invalid @enderror" id="agreement" required>
                        <label class="form-check-label" for="agreement">
                            I agree to the <a href="#" data-bs-toggle="modal"
                                data-bs-target="#agreementModal">Terms and Conditions</a>
                        </label>
                        @error('agreement')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul>
                        ...
                        <li><em>Privacy:</em> We respect your privacy and will protect your data as outlined in our <a
                    ...
                    <p>This is a <b>sample agreement</b> and may span multiple pages. You are responsible for reading
                        and understanding all terms before agreeing.</p>
                    <p>For more details, contact us at <a href="mailto:support@example.com">support@example.com</a>.
                    </p>
                </div>
